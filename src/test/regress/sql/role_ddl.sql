...
SELECT pg_get_role_ddl('regress_role_ddl_test1', true);
SELECT pg_get_role_ddl('regress_role_ddl_test1', false);
...
SELECT * FROM pg_get_role_ddl_statements('regress_role_ddl_test4', true);
SELECT * FROM pg_get_role_ddl_statements('regress_role_ddl_test4', false);
